...
public class MessageConstants {
    ...
    public static final String FORMATO_LOGIN_INVALIDO = "Por favor, informe o login em formato válido 'exemplo@email.com'";
    public static final String SENHA_OBRIGATORIA = "Por favor, informe a senha.";
